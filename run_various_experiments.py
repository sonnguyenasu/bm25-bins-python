...
def do_search(
    ...
    two_choice_bins = top_k_bins(search, alphabet, config)
    fullness_histogram(
        two_choice_bins[1],
        True,
    ...
    three_choice_bins = top_k_bins(search, alphabet, config)
    fullness_histogram(
        three_choice_bins[1],
        True,
    ...
    three_choice_bins_remove_one = top_k_bins(search, alphabet, config)
    fullness_histogram(
    ...
    config.max_load_factor = 1
    two_choice_bins_max_load = top_k_bins(search, alphabet, config)
    fullness_histogram(
    ...
    # hundred_choice_ten_max_load = top_k_bins(search, alphabet, config)
    # fullness_histogram(
    ...
    config.min_overlap_factor = 1
    config.max_load_factor = 1
    four_choice_min_overlap_max_overlap = top_k_bins(search, alphabet, config)
    fullness_histogram(
